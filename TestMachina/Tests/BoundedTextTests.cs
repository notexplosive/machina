...
namespace TestMachina.Tests
{
    public class BoundedTextTests
    {
        ...
        public void text_measurer_generates_accurate_output()
        {
            ...
            var expectedX = 89;
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.X.Should().Be(expectedX);
        ...
        public void pinning_tests_for_text_measurer_centered()
        {
            ...
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.X.Should().Be(7);
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.Y.Should().Be(0);

            textMeasurer.Lines[1].textContent.Should().Be("referencing some meme here in this string. ");
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.X.Should().Be(8);
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.Y.Should().Be(3);

            textMeasurer.Lines[2].textContent.Should().Be("But then I changed my mind. ");
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.X.Should().Be(23);
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.Y.Should().Be(6);
        }
        ...
        public void pinning_tests_for_text_measurer_topleft()
        {
            ...
            textMeasurer.Lines.Should().HaveCount(3);
            textMeasurer.Lines[0].textContent.Should().Be("This is a very long string. I thought about ");
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.X.Should().Be(0);
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.Y.Should().Be(0);

            textMeasurer.Lines[1].textContent.Should().Be("referencing some meme here in this string. ");
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.X.Should().Be(0);
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.Y.Should().Be(3);

            textMeasurer.Lines[2].textContent.Should().Be("But then I changed my mind. ");
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.X.Should().Be(0);
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.Y.Should().Be(6);
        }
        ...
        public void pinning_tests_for_text_measurer_bottomright()
        {
            ...
            textMeasurer.Lines.Should().HaveCount(3);
            textMeasurer.Lines[0].textContent.Should().Be("This is a very long string. I thought about ");
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.X.Should().Be(13);
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.Y.Should().Be(0);

            textMeasurer.Lines[1].textContent.Should().Be("referencing some meme here in this string. ");
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.X.Should().Be(15);
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.Y.Should().Be(3);

            textMeasurer.Lines[2].textContent.Should().Be("But then I changed my mind. ");
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.X.Should().Be(45);
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.Y.Should().Be(6);
        }
        ...
        public void pinning_tests_for_text_measurer_centered_large_middle_string()
        {
            ...
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.X.Should().Be(34);
            textMeasurer.Lines[0].positionRelativeToTopLeftOfText.Y.Should().Be(0);

            textMeasurer.Lines[1].textContent.Should().Be("looooooooooong.... middle.... string ");
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.X.Should().Be(14);
            textMeasurer.Lines[1].positionRelativeToTopLeftOfText.Y.Should().Be(3);

            textMeasurer.Lines[2].textContent.Should().Be("short bottom ");
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.X.Should().Be(38);
            textMeasurer.Lines[2].positionRelativeToTopLeftOfText.Y.Should().Be(6);
        }
