    ...
    class LayoutTests : TestGroup
    {
        public LayoutTests() : base("Layout Tests")
        {
            AddTest("Basic Vertical Layout", test =>
            {
                ...
                groupActor.Position = new Vector2(50, 50);
                ...
                test.Expect(110, e4.actor.Position.Y, "E4 is at expected Y pos");
            });
            ...
            AddTest("Basic Vertical Layout with Padding", test =>
            {
                ...
                test.Expect(125, e4.actor.Position.Y, "E4 is at expected Y pos");
            });
            ...
            AddTest("Basic Vertical Layout Stretch", test =>
            {
                ...
                test.Expect(50, e1.actor.Position.Y, "E1 is at expected Y pos");
                test.Expect(143, e1.boundingRect.Height, "E1 is expected height");
                test.Expect(200, e2.actor.Position.Y, "E2 is at expected Y pos");
