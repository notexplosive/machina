...
namespace Machina.Components
{
    public class BoundedTextRenderer : BaseComponent
    {
        ...
        public override void DebugDraw(SpriteBatch spriteBatch)
        {
            ...
            {
                var pos = new Vector2(line.positionRelativeToTopOfText.X + this.boundingRect.Rect.X, line.positionRelativeToTopOfText.Y + measurer.TopOfText() + this.boundingRect.Rect.Y);
