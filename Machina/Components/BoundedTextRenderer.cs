...
namespace Machina.Components
{
    public class BoundedTextRenderer : BaseComponent
    {
        ...
        public Point TextLocalPos => CreateMeasuredText().GetTextLocalPos(this.boundingRect.Height, (int)transform.Position.X);
        ...
        private List<RenderableText> GetRenderedLines()
        {
            ...
            var localPos = measurer.GetTextLocalPos(this.boundingRect.Height, (int)transform.Position.X);
