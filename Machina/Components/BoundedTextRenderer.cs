...
namespace Machina.Components
{
    public class BoundedTextRenderer : BaseComponent
    {
        ...
        public override void DebugDraw(SpriteBatch spriteBatch)
        {
            ...
            {
                var pos = new Vector2(line.positionRelativeToTopLeftOfText.X + this.boundingRect.Rect.X, line.positionRelativeToTopLeftOfText.Y + measurer.TopOfText() + this.boundingRect.Rect.Y);
